...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $tipo = new Tipo_Programa;
        $tipo->nb_tipo_programa = 'Semanal';
        $tipo->save();

        $tipo = new Tipo_Programa;
        $tipo->nb_tipo_programa = 'Diario';

        $tipo->save();


        $tipo = new DiaSemanales;
        $tipo->nb_dia_semanales = 'lunes';
        $tipo->save();

        $tipo = new DiaSemanales;
        $tipo->nb_dia_semanales = 'martes';

        $tipo->save();

        $tipo = new DiaSemanales;
        $tipo->nb_dia_semanales = 'miércoles';

        $tipo->save();


        $tipo = new DiaSemanales;
        $tipo->nb_dia_semanales = 'jueves';
        ...
        $tipo = new DiaSemanales;
        $tipo->nb_dia_semanales = 'viernes';

        $tipo->save();

        $tipo = new DiaSemanales;
        $tipo->nb_dia_semanales = 'sábado';

        $tipo->save();


        $tipo = new DiaSemanales;
        $tipo->nb_dia_semanales = 'domingo';
        ...
        $user->email = 'lperez@rsdstereo.com';
        $user->password = 'admin';
